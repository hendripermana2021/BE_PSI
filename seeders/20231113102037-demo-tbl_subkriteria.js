    ...
    await queryInterface.bulkInsert(
      ...
      [
        ...
        },
        {
          ...
          name_sub: "Signifikan",
          description:
            "Terjadi peningkatan kapasitas masyarakat dalam hal pengetahuan, keterampilan, dan partisipasi dalam pembangunan. Terdapat data kualitatif dan kuantitatif yang mendukung.",
          id_kriteria: 7,
          value: 3,
          createdAt: new Date(),
          updatedAt: new Date(),
        },
        {
          ...
          name_sub: "Sedang",
          description:
            "Terjadi peningkatan kapasitas masyarakat, tetapi tidak signifikan.",
          id_kriteria: 7,
          value: 2,
          createdAt: new Date(),
          updatedAt: new Date(),
        },
        {
          ...
          name_sub: "Tidak Ada",
          description:
            "Tidak ada peningkatan kapasitas masyarakat yang terukur.",
          id_kriteria: 7,
          value: 1,
          createdAt: new Date(),
          updatedAt: new Date(),
        ...
        {
          //24
          name_sub: "Sangat Aktif",
          description:
            "Lembaga pendidikan dan lembaga masyarakat terlibat secara aktif dan berkelanjutan dalam seluruh tahapan program, mulai dari perencanaan, pelaksanaan, hingga monitoring dan evaluasi. Terdapat bukti nyata keterlibatan, seperti kehadiran dalam rapat, kontribusi ide dan sumber daya, serta partisipasi aktif dalam kegiatan lapangan. Dokumentasi keterlibatan tersedia secara lengkap.",
          id_kriteria: 8,
          value: 3,
          createdAt: new Date(),
          updatedAt: new Date(),
        },
        {
          ...
          name_sub: "Aktif",
          description:
            "Lembaga pendidikan dan lembaga masyarakat terlibat dalam beberapa tahapan program, tetapi keterlibatannya tidak konsisten atau menyeluruh. Partisipasi mungkin terbatas pada beberapa kegiatan saja, dan dokumentasi keterlibatan kurang lengkap.",
          id_kriteria: 8,
          value: 2,
          createdAt: new Date(),
          updatedAt: new Date(),
        ...
        {
          //24
          name_sub: "Tidak Aktif",
          description:
            "Lembaga pendidikan dan lembaga masyarakat tidak terlibat atau hanya terlibat secara minimal dalam program. Tidak ada bukti nyata keterlibatan yang signifikan dalam berlangsungnya program.",
          id_kriteria: 8,
          value: 1,
          createdAt: new Date(),
          updatedAt: new Date(),
